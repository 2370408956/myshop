...
<form class="layui-form" action="">
  <div class="addrcon">
    <ul>
      ...
      <li class="addr-detail"><em>详细地址</em><input type="text"   id="address_area" placeholder="20个字以内" class="addr"></li>
    </ul>
    <div class="setnormal">
            ...
            {{--form.on('select(filter)', function(data){--}}
                ...
                {{--$.post(--}}
                    ...
                    {{--function(res){--}}
                        ...
                        {{--}--}}
                        {{--// console.log($('#city').next('div').find("dl[class='layui-anim layui-anim-upbit']"));--}}
                        {{--$('#city').next('div').find("dl[class='layui-anim layui-anim-upbit']").html(_option);--}}
                    {{--},--}}
                    {{--'json'--}}
                {{--)--}}
            {{--});--}}
